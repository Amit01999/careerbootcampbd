  ...
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#09090B]">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-[#C49B4B]/[0.04] rounded-full blur-[100px]" />
      </div>
      ...
      <div className="mx-auto max-w-[1200px] relative z-10">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-20">
            ...
            <span className="ml-3 text-lg text-white/40">Loading exams...</span>
          </div>
        ) : exams.length === 0 ? (
            ...
            {exams.map((exam, index) => (
              ...
              >
                ...
                >
                  ...
                  <Card className="relative h-full border border-white/[0.06] group-hover:border-[#C49B4B]/20 shadow-lg transition-all duration-300"
                    style={{
                  ...
                  >
                    <CardHeader className="p-5">
                      <div className="flex items-center justify-between mb-3">
                        <Badge className="bg-[#C49B4B]/10 text-[#D4AF5A] font-medium px-2.5 py-1 border border-[#C49B4B]/20 shadow-sm">
                      ...
                      <CardTitle className="text-base font-semibold text-white leading-snug mb-4 group-hover:text-[#D4AF5A] transition-colors">
                        {exam.title}
                      </CardTitle>
                      ...
                      <Button
                        className="w-full btn-premium shadow-md hover:shadow-lg flex items-center justify-center gap-2 transition-transform hover:scale-105"
                        onClick={() =>
